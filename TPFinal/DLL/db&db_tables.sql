...
CREATE TABLE notificacion_cambio_estado(
	...
	,ticket_id int not null CONSTRAINT FK_notificacion_cambio_estado_ticket FOREIGN KEY (ticket_id) REFERENCES ticket(id_ticket)
	,estado_a_informar int not null CONSTRAINT FK_notificacion_cambio_estado_estado_ticket FOREIGN KEY (estado_a_informar) REFERENCES estado_ticket(id_estado_ticket)
	,fecha datetime 
)
